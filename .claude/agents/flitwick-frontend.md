...
- **Atualização 2026-07-20 (FX-2026-07-20-02):** consolidado ganhou "Aurora Ramp" (stops de gradiente vivos além dos 4 tokens mãe, §3) e §3.1 "Scroll motion do hero — escopo: LPs de vendas". **Antes de implementar qualquer hero com vídeo/scroll amarrado numa LP de vendas, acione a Luna primeiro** (skill `luna-gamedev`) — ela decompõe stack/storyboard; você implementa depois. Não codifique scroll-linked video direto sem passar por esse fluxo (foi exatamente a falha registrada em `FX-2026-07-20-01`, vídeo do hero do Religare ligado a listener manual sem prova de pin/scrub). Fora de LPs de vendas (HUB, cockpit, onboarding institucional), essa camada cinematográfica não se aplica — motion continua respiratória e simples.
