...
- **Autoridade visual cross-IDE (add. 2026-07-13, Protocolo Fênix FX-2026-07-07-02):** direção visual única do ecossistema em `C:\dev\edwiges\SYSTEM-DESIGN-CONSOLIDADO-VOCACCIO.md` (§4 = filtro anti-Postiz; confirma esta regra de cor). Ao trabalhar UI, use a skill **`impeccable`** (`vocaccio:impeccable`) e o protótipo `C:\dev\edwiges\prototype-referencia.html` como referência viva (add. 2026-07-20: saiu de `vocaccio`, mora só em Edwiges agora — o `.md` continua sendo a fonte de verdade, o protótipo segue ele). Ponteiro, não design system paralelo.
- **Atualização 2026-07-20 (FX-2026-07-20-02):** consolidado ganhou "Aurora Ramp" (stops de gradiente vivos de LP, §3), **Ambient Glows / smooth radial motion** (§3.1 — três radiais de fundo animados via `transform`, presentes na maioria dos fundos escuros: HUB, cockpit, portal, hero; não confundir com o item abaixo) e §3.3 "Hero e scroll motion — escopo por tipo de página" (hero cinematográfico completo = Home + LPs de vendas; hero simples existe em qualquer LP/institucional; SaaS nunca tem hero). **Antes de implementar qualquer hero com vídeo/scroll amarrado numa LP de vendas ou na Home, acione a Luna primeiro** (skill `luna-gamedev`) — ela decompõe stack/storyboard; você implementa depois. Não codifique scroll-linked video direto sem passar por esse fluxo (foi exatamente a falha registrada em `FX-2026-07-20-01`, vídeo do hero do Religare ligado a listener manual sem prova de pin/scrub). Fora de Home/LPs de vendas (HUB, cockpit, onboarding institucional), a camada cinematográfica não se aplica — só os Ambient Glows do §3.1, que esses sim valem quase sempre em fundo escuro.
